...
def filtrar():
    ...
    cursor.execute(f"select * from libros where precio='{autor_filtro}'")
...
def ventana_empleado():
    ...
    ventana.config(bg="#2980b9")

    tk.Label(ventana, text="ADMINISTRAR LIBROS", font=("lexend", 20, "bold"), bg="#2980b9", fg="#d6eaf8").place(x=500, y=5)

    label_titulo=tk.Label(ventana, text="Titulo", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_titulo.place(x=20, y=30)
    
    label_autor=tk.Label(ventana, text="Autor", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_autor.place(x=20, y=90)

    label_editorial=tk.Label(ventana, text="Editorial", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_editorial.place(x=20, y=150)

    label_año=tk.Label(ventana, text="Fecha de publicacion (yyyy-mm-dd)", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_año.place(x=20, y=210)

    label_precio=tk.Label(ventana, text="Precio", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_precio.place(x=20, y=270)

    label_id=tk.Label(ventana, text="ID", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_id.place(x=500, y=150)
    
    label_filtro=tk.Label(ventana, text="Filtrar por autor", font=("Arial", 12, "bold"),bg="#2980b9",fg="#d6eaf8")
    label_filtro.place(x=1000, y=150)

    entry_filtro=tk.Entry(ventana, width=30, relief="flat")
    entry_filtro.place(x=1000, y=180)

    entry_id=tk.Entry(ventana, width=20, relief="flat")
    ...
    tk.Button(ventana, text="Crear", command=crear, height=3, width=10, font=("Arial",12),bg="#b4c5e4").place(x=250, y=100)
    tk.Button(ventana, text="Editar", command=editar, height=3, width=10, font=("Arial",12),bg="#b4c5e4").place(x=500, y=250)
    tk.Button(ventana, text="Eliminar", command=eliminar, height=3, width=10, font=("Arial",12),bg="#ff6978").place(x=600, y=250)
    tk.Button(ventana, text="Filtrar", command=filtrar, height=3, width=10, font=("Arial",12),bg="#b4c5e4").place(x=1000, y=250)
    tk.Button(ventana, text="Cancelar", command=mostrar, height=3, width=10, font=("Arial",12),bg="#ff6978").place(x=1100, y=250)
    tk.Button(ventana, text="Salir", command=lambda: salir(ventana=ventana), height=3, width=10, font=("Arial",12),bg="#48c9b0").place(x=1300, y=450)
